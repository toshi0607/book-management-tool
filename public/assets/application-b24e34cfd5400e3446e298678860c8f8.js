...
(function() {
  ...
  init = function() {
    return $('.isbn_search').on('ajax:success', function(e, data) {
      var author, bookTitle, i, publisherName;
      i = $(this).attr('id');
      ...
      return $('#form_book_collection_books_attributes_' + i + '_description').val(("" + publisherName) + " " + ("" + author));
    });
  };
